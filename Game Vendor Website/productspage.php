...
<head>
  ...
  xmlhttp.open("GET","productspage_call.php",true);
  xmlhttp.send();
...
<body onload="displayCart();">
  ...
  <div id="menu">
    <ul class="items">
      ...
      <li>
        <form method="post">
          <!-- <a href="search.php" style="text-decoration:underline;">Search</a> --><input type="text" onKeyUp="fx(this.value)" name="qu" id="qu" class="textbox" placeholder="Search here">
