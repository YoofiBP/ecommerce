...
<head>
  ...
  <script>
function selected($country,$choice){
...
<br>
          ...
          <div id="rightside">
            ...
            <div id="content">
              <form enctype="multipart/form-data" method="POST" onsubmit="return validateAll(this)" action="register.php" name="register">
                <h1>Register</h1>
                Name: <input type="text" name="username" value="<?=@$username?>"/><span class="error">* <?php echo $user_error;?></span>
                <br>
                <br>
                ...
                <br>
                <br>
                Confirm Password: <input type="password" name="confirm_password" value="<?=$confirm_password?>"/><span class="error">* <?php echo $confirm_password_error;?></span>
                <br>
                <br>
    ...
    <option value="0">Select Country</option>
  	...
  	<option value="ZWE">Zimbabwe</option>
                ...
                <br>
                <br>
                City: <input type="text" name="city" id="city" value="<?=@$city?>"/><span class="error">* <?php echo $city_error;?></span>
                <br>
                <br>
                Contact: <input type="number" name="number" id="number" value="<?=@$phone?>"/><span class="error">* <?php echo $phone_error;?></span>
                <br>
                <br>
Upload Customer Image: <input type="file" id="upload" name="file" value="<?=@$image?>"/><span class="error">* <?php echo $image_error;?></span>
<br>
<br>
Address: <input type="text" name="address" value="<?=@$address?>"/><span class="error">* <?php echo $address_error;?></span>
<br>
<br>
